...
// Used for creating PermissionsTokens
        ...
        SecurityException& exception)
{
    ...
    if (nullptr != stack)
    {
        ...
        else
        {
            ...
            if (!PKCS7_verify(p7, stack, nullptr, indata, out, PKCS7_TEXT | PKCS7_NOVERIFY | PKCS7_NOINTERN) && !PKCS7_verify(p7, stack, nullptr, indata, out, PKCS7_NOVERIFY | PKCS7_NOINTERN))
            {
